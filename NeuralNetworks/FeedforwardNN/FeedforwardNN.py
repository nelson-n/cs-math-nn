...
train_imgs = gzip.open(data_dir + '/data/MNIST' + 'train-images-idx3-ubyte.gz', 'rb').read()
train_lbls = gzip.open(data_dir + '/data/MNIST' + 'train-labels-idx1-ubyte.gz', 'rb').read()
test_imgs  = gzip.open(data_dir + '/data/MNIST' + 't10k-images-idx3-ubyte.gz', 'rb').read()
test_lbls  = gzip.open(data_dir + '/data/MNIST' + 't10k-labels-idx1-ubyte.gz', 'rb').read()
